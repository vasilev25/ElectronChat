...
class AppImageTarget extends (_core || _load_core()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const vendorDir = yield (0, (_binDownload || _load_binDownload()).getBinFromGithub)("appimage", "9.0.2", "9Y6o5svZhJMeiVCuzy8PmKk0aERoX7LdqssBkiV/oglwGFvKdR2UK0jCJv5+cU5ZRwheq04npiRJ71qMBGVLIA==");
            ...
            if (publishConfig != null) {
                yield (0, (_fsExtraP || _load_fsExtraP()).writeFile)(_path.join(packager.getResourcesDir(appInStageDir), "app-update.yml"), (0, (_jsYaml || _load_jsYaml()).safeDump)(publishConfig));
            }
            ...
            yield (0, (_builderUtil || _load_builderUtil()).exec)(_path.join(vendorToolDir, "appimagetool"), args, {
                env: Object.assign({}, process.env, { PATH: `${vendorToolDir}:"/Users/develar/Library/Caches/electron-builder/linux-tools/linux-tools-mac-10.12.3/bin:${process.env.PATH}`,
            ...
            const blockMapInfo = yield (0, (_appPackageBuilder || _load_appPackageBuilder()).createDifferentialPackage)(resultFile);
            const updateInfo = {

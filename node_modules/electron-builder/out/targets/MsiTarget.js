...
var _CommonWindowsInstallerOptions;

function _load_CommonWindowsInstallerOptions() {
    return _CommonWindowsInstallerOptions = require("../options/CommonWindowsInstallerOptions");
}
...
class MsiTarget extends (_core || _load_core()).Target {
    constructor(packager, outDir) {
        ...
        this.outDir = outDir;
        this.vm = process.platform === "win32" ? new (_vm || _load_vm()).VmManager() : new (_wine || _load_wine()).WineVmManager();
        this.options = (0, (_deepAssign || _load_deepAssign()).deepAssign)(this.packager.platformSpecificBuildOptions, this.packager.config.msi);
    }
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const vm = _this.vm;
            const commonOptions = (0, (_CommonWindowsInstallerOptions || _load_CommonWindowsInstallerOptions()).getEffectiveOptions)(_this.options, _this.packager);
            if (commonOptions.isAssisted) {
                ...
                (0, (_builderUtil || _load_builderUtil()).warn)(`MSI DOESN'T SUPPORT assisted installer. Please use NSIS instead.`);
            }
            ...
            yield _this.light(objectFiles, vm, artifactPath, appOutDir, vendorPath, stageDir.tempDir);
    ...
    computeFileDeclaration(appOutDir) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const commonOptions = (0, (_CommonWindowsInstallerOptions || _load_CommonWindowsInstallerOptions()).getEffectiveOptions)(_this4.options, _this4.packager);

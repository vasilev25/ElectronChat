...
let getWindowsVm = exports.getWindowsVm = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (debugLogger) {
        const vmList = (yield (0, (_parallels || _load_parallels()).parseVmList)(debugLogger)).filter(function (it) {
            return it.os === "win-10";
        });
        if (vmList.length === 0) {
        ...
        return new (_parallels || _load_parallels()).ParallelsVmManager(vmList.find(function (it) {

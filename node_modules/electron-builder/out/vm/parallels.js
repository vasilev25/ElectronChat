...
exports.ParallelsVmManager = exports.parseVmList = undefined;
...
/** @internal */
let parseVmList = exports.parseVmList = (() => {
...
class ParallelsVmManager extends (_vm || _load_vm()).VmManager {
    constructor(vm) {
        super();
        this.vm = vm;
    ...
    spawn(file, args, options, extraOptions) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            return yield (0, (_builderUtil || _load_builderUtil()).spawn)("prlctl", ["exec", _this2.vm.id, file].concat(args), options, extraOptions).catch(function (error) {

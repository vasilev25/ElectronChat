    ...
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (event, _publishConfigs) {
        ...
        for (let publishConfig of publishConfigs) {
            ...
            for (const channel of computeChannelNames(packager, publishConfig)) {
                ...
                const updateInfoFile = _path.join(dir, (publishConfig.provider === "bintray" ? `${version}_` : "") + getUpdateInfoFileName(channel, packager, event.arch));
...
let createUpdateInfo = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (version, event, releaseInfo) {
        ...
        return Object.assign({ version, releaseDate: new Date().toISOString(), path: url, url }, customUpdateInfo, { sha512: (customUpdateInfo == null ? null : customUpdateInfo.sha512) || (yield (0, (_builderUtil || _load_builderUtil()).hashFile)(event.file)) }, releaseInfo);
    });

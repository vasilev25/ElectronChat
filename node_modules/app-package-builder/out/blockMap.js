    ...
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (archiveFile) {
        ...
        try {
            if (!archiveFile.endsWith(".7z")) {
                ...
                return yield appendBlockMapData(blockMap, archiveFile, fd, null, true);
            }
            ...
            return yield appendBlockMapData(blockMap, archiveFile, fd, sevenZFile.archive.headerSize, false);
        } catch (e) {
...
let appendBlockMapData = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (blockMap, archiveFile, fd, headerSize, addLength) {
        ...
        if (process.env.DEBUG_BLOCKMAP) {
            ...
            yield (0, (_fsExtraP || _load_fsExtraP()).writeFile)(`${archiveFile}.blockMap.yml`, buffer);
            console.log(`BlockMap size: ${buffer.length}, compressed: ${blockMapFileData.length}`);
        }
        return packageFileInfo;
    });

    return function appendBlockMapData(_x2, _x3, _x4, _x5, _x6) {
        return _ref2.apply(this, arguments);
    };
})();

let createPackageFileInfo = exports.createPackageFileInfo = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (file, blockMapSize) {
        return {
            path: file,
    ...
    return function createPackageFileInfo(_x7, _x8) {
...
let computeBlockMap = exports.computeBlockMap = (() => {
    ...
    return function computeBlockMap(_x9) {
        return _ref4.apply(this, arguments);
    };
})();

let doComputeBlockMap = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (files, fd) {
        ...
        const blocks = yield (_bluebirdLst2 || _load_bluebirdLst2()).default.map(files, (() => {
            var _ref6 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (file) {
    ...
    return function doComputeBlockMap(_x10, _x11) {
